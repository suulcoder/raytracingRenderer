...
r.scene = [
  ...
  Sphere(V3(-3.2, -1.3, -15), 2, brown_skin),
  Sphere(V3(-1.5, 0, -14.5), 1.1, brown_skin),
  Sphere(V3(-4.9, 0, -14.5), 1.1, brown_skin),
  Sphere(V3(-2.1, -2.6, -14.1), 1.1, brown_skin),
  Sphere(V3(-4.5, -2.6, -14.1), 1.1, brown_skin),
  Sphere(V3(-3.2, 1.6, -14.9), 1.7, brown_skin),
  Sphere(V3(-2.2, 2.7, -14.4), 0.7, brown_skin),
  Sphere(V3(-4.2, 2.7, -14.4), 0.7, brown_skin),
  Sphere(V3(-3.2, 1.3, -13.3), 0.2, brown_skin),
  Sphere(V3(-3.6, 2.1, -13.5), 0.2, eye),
  Sphere(V3(-2.8, 2.1, -13.5), 0.2, eye),
]
r.render(stereogram=True)
r.write('autostereogram.bmp')